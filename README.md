...
1. Install by downloading (click the green 'clone or download' button above and then click 'download ZIP') and unzipping. Then in chrome navigate to chrome://extensions/ and click 'load unpacked extension' and go the tiddlysaver/extension/dir to select the extension (it's the directory containing the 'manifest.json').
